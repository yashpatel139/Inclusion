...
const DonateForm = () => {
  ...
  const [state, handleSubmit] = useForm("xvgpakev"); // Replace with your actual Formspree form ID
  ...
  const handleFormSubmit = async (e) => {
    ...
    formData.append('amount', amount === 'custom' ? customAmount : amount);
    formData.append('name_first', name.first);
    formData.append('name_last', name.last);
    ...
    formData.append('address_country', address.country);
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white border-2 border-gray-500 rounded-lg shadow-lg p-4 mb-5">
      {/* Introduction Text */}
